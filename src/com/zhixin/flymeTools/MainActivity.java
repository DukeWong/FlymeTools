...
public class MainActivity extends BaseActivity {
    ...
    protected void RunBackupOrRestore(final boolean restore) {
        ...
        builder.setPositiveButton(R.string.Yes, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                PageTask task = new PageTask(restore);
                task.execute(MainActivity.this.getPackageName(), restore ? "1" : "0");
            }
        });
    ...
    class PageTask extends AsyncTask<String, Integer, String> {
        ...
        public PageTask(final boolean restore) {
        ...
        public void backupFile(String packageName, boolean restore) {
            ...
            File thisApp = new File(sourceDir, ROOT_DIR + packageName + "/shared_prefs");
            File AppList = new File(sourceDir, ROOT_DIR + packageName + "/apps_prefs");
            new File(targetDir, ROOT_DIR + packageName + "/shared_prefs").delete();
            new File(targetDir, ROOT_DIR + packageName + "/apps_prefs").delete();
        ...
        protected String doInBackground(String... params) {
            backupFile(params[0], params[1] == "1");
            return null;
        }
    }
}
