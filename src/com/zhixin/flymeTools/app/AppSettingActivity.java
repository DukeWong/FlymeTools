...
public class AppSettingActivity extends BaseSettingActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isSysApp = intent.getBooleanExtra("isSysApp", false);
    ...
    protected PreferenceFragment onCreateFragment(Bundle savedInstanceState) {
        if (isSysApp) {
            ...
            sysSettingFragment.setAppName(appName);
            sysSettingFragment.setPackageName(packageName);
            return sysSettingFragment;
        } else {
