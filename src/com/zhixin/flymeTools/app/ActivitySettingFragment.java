...
public class ActivitySettingFragment extends AppBaseFragment {
    ...
    protected void bindStatusBarDefault(SharedPreferences sharedPreferences) {
        ...
        m_change_status_bar_mode.setChecked(sharedPreferences.getBoolean(preference_change_status_bar_mode, appSharedPreferences.getBoolean(preference_change_status_bar_mode, false)));
